...
# The cockblockd daemon binary is +i'd too so a root shell cannot rm/overwrite
...
SET_LIST=()
for f in "$DEST/cockblock_loader" "$DEST/cockblock_lsm.bpf.o" "$DEST/cockblock-updat" "/opt/cockblock/cockblockd"; do
